    ...
    public class DAL_Execute
    {
        ...
        public int ejecutarScalar(string x_Procedimiento, SqlParameter[] x_parametros = null)
        {
            ...
            try
            {
                ...
                if (x_parametros == null || x_parametros.Length == 0)
                    resultado = SqlHelper.ExecuteScalar(transaccion, CommandType.StoredProcedure, x_Procedimiento);
                else
                    resultado = SqlHelper.ExecuteScalar(transaccion, CommandType.StoredProcedure, x_Procedimiento, x_parametros);
