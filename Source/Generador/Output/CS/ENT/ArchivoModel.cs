...
namespace DXCTechnology.Belcorp.ePlanning.EntityLayer
{
	public class ArchivoModel
	{
		...
		/// Initializes a new instance of the ArchivoModel class.
		/// </summary>
		public ArchivoModel(string NombreCargado, string NombreHistorico, short IdPalanca, int IdCampanaPlaneacion, int IdCampanaProceso, byte NumeroEspacios, byte UnidadesLimite, int IdEstado, DateTime FechaEstado, string UsuarioCreacion, DateTime FechaCreacion, string UsuarioModificacion, DateTime FechaModificacion)
		{
		...
		/// Initializes a new instance of the ArchivoModel class.
		/// </summary>
		public ArchivoModel(long IdArchivo, string NombreCargado, string NombreHistorico, short IdPalanca, int IdCampanaPlaneacion, int IdCampanaProceso, byte NumeroEspacios, byte UnidadesLimite, int IdEstado, DateTime FechaEstado, string UsuarioCreacion, DateTime FechaCreacion, string UsuarioModificacion, DateTime FechaModificacion)
		{
