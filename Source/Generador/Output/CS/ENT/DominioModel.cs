...
namespace DXCTechnology.Belcorp.ePlanning.EntityLayer
{
	public class DominioModel
	{
		...
		/// Initializes a new instance of the DominioModel class.
		/// </summary>
		public DominioModel(string DescripcionLarga, string DescripcionCorta, bool IndicadorVigencia, string Nemonico, byte CamposAdicionales, string DescripcionCampo1, string DescripcionCampo2, string DescripcionCampo3, string DescripcionCampo4, string DescripcionCampo5, string UsuarioCreacion, DateTime FechaCreacion, string UsuarioModificacion, DateTime FechaModificacion)
		{
		...
		/// Initializes a new instance of the DominioModel class.
		/// </summary>
		public DominioModel(int IdDominio, string DescripcionLarga, string DescripcionCorta, bool IndicadorVigencia, string Nemonico, byte CamposAdicionales, string DescripcionCampo1, string DescripcionCampo2, string DescripcionCampo3, string DescripcionCampo4, string DescripcionCampo5, string UsuarioCreacion, DateTime FechaCreacion, string UsuarioModificacion, DateTime FechaModificacion)
		{
