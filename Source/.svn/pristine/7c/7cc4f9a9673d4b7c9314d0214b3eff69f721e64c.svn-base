...
namespace DataTierGenerator
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		public MainForm()
	    {
			...
			using (RegistryKey registryKey = Registry.CurrentUser.CreateSubKey(@"Software\Adrian Anttila\CSharpDataTier"))
	        {
				...
				projectTextBox.Text = (string) registryKey.GetValue("Project", String.Empty);
				...
				dtoSuffixTextBox.Text = (string) registryKey.GetValue("DtoSuffix", String.Empty);
                bloPrefix.Text = (string)registryKey.GetValue("BloSuffix", String.Empty);
            }
		}
		...
		private void GenerateButton_Click(object sender, System.EventArgs e)
    	{
			...
			try
	        {
				...
				Generator.Generate(outputDirectory, connectionString, grantUserTextBox.Text, storedProcedurePrefixTextBox.Text, multipleFilesCheckBox.Checked, projectTextBox.Text, namespaceTextBox.Text, daoSuffixTextBox.Text.Trim(), dtoSuffixTextBox.Text.Trim(), bloPrefix.Text.Trim());

                #region Save the current state to the Registry
                using (RegistryKey registryKey = Registry.CurrentUser.CreateSubKey(@"Software\Adrian Anttila\CSharpDataTier"))
	            {
					...
					registryKey.SetValue("Project", projectTextBox.Text, RegistryValueKind.String);
					...
					registryKey.SetValue("DtoSuffix", dtoSuffixTextBox.Text, RegistryValueKind.String);
                    registryKey.SetValue("BloSuffix", bloPrefix.Text, RegistryValueKind.String);
		...
		private void InitializeComponent()
	    {
            ...
            this.bloPrefix = new System.Windows.Forms.TextBox();
            ...
            this.generateButton.Location = new System.Drawing.Point(480, 304);
            ...
            // csGroupBox
            // 
            this.csGroupBox.Controls.Add(this.bloPrefix);
            this.csGroupBox.Controls.Add(this.label1);
            ...
            this.csGroupBox.Size = new System.Drawing.Size(288, 162);
            ...
            this.dtoSuffixLabel.Text = "ENT Prefix:";
            // 
            // daoSuffixTextBox
            // 
            ...
            this.daoSuffixLabel.Text = "DAL Prefix:";
            // 
            // namespaceTextBox
            // 
            ...
            this.label1.Text = "BLL Prefix:";
            // 
            // bloPrefix
            // 
            this.bloPrefix.Location = new System.Drawing.Point(78, 132);
            this.bloPrefix.Name = "bloPrefix";
            this.bloPrefix.Size = new System.Drawing.Size(204, 20);
            this.bloPrefix.TabIndex = 18;
            // 
            // MainForm
            // 
