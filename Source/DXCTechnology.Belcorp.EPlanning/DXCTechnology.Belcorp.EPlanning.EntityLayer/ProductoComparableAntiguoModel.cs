...
{
	public class ProductoComparableAntiguoModel
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ProductoComparableAntiguoModel class.
		/// </summary>
		public ProductoComparableAntiguoModel()
		{
		}
		...
		/// Initializes a new instance of the ProductoComparableAntiguoModel class.
		/// </summary>
		public ProductoComparableAntiguoModel(byte IdPais, string CUC, string SAP, string CUCAntiguo, string SAPAntiguo, string BPCSGenericoAntiguo, string BPCSTonoAntiguo, string DescripcionGenericoAntiguo, string DescripcionTonoAntiguo, string UsuarioCreacion, DateTime FechaCreacion, string UsuarioModificacion, DateTime FechaModificacion)
		{
			this.IdPais = IdPais;
			this.CUC = CUC;
			this.SAP = SAP;
